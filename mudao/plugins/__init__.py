...
from PyQt5.QtWidgets import QMessageBox, QWidget, QApplication, QMainWindow, QShortcut, QDockWidget, QTabBar
...
class SpyderPluginMixin(object):
    ...
    def create_dockwidget(self):
        ...
        dock = DockWidget(self.get_plugin_title(), self.main) #, flags)
...
class PluginWidget(QWidget, SpyderPluginMixin):
    """
    ...
    if PYQT5:
        def __init__(self, parent, **kwds):
            ...
            super(PluginWidget, self).__init__(parent, **kwds)
