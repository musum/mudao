...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.rightView.headerItem().setText(1, _translate("Form", "Type"))
        self.rightView.headerItem().setText(2, _translate("Form", "Size"))
        self.rightView.headerItem().setText(3, _translate("Form", "Time"))
        ...
        self.rightView.topLevelItem(0).setText(1, _translate("Form", "Folder"))
        self.rightView.topLevelItem(0).setText(3, _translate("Form", "2018.09.12"))
