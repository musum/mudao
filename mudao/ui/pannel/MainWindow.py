...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/test/ui/resources/img/power_exit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_quit.setIcon(icon1)
        self.action_quit.setObjectName("action_quit")
        self.action_file = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/test/ui/resources/img/folder.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_file.setIcon(icon2)
        self.action_file.setObjectName("action_file")
        self.action_cmd = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/test/ui/resources/img/terminal.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_cmd.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/test/ui/resources/img/restart1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
